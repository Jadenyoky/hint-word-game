...
export default function Home() {
  ...
  // ];
  const eng = [
    { name: "Afghanistan", length: 11, category: "Asia", mode: "Normal" },
    { name: "Albania", length: 7, category: "Europe", mode: "Normal" },
    { name: "Algeria", length: 7, category: "Africa", mode: "Normal" },
    { name: "Andorra", length: 7, category: "Europe", mode: "Normal" },
    { name: "Angola", length: 6, category: "Africa", mode: "Normal" },
    { name: "Antigua", length: 7, category: "NorthAmerica", mode: "Normal" },
    { name: "Argentina", length: 9, category: "SouthAmerica", mode: "Normal" },
    { name: "Armenia", length: 7, category: "Asia", mode: "Normal" },
    { name: "Australia", length: 9, category: "Oceania", mode: "Normal" },
    { name: "Austria", length: 7, category: "Europe", mode: "Normal" },
    { name: "Azerbaijan", length: 10, category: "Asia", mode: "Normal" },
    { name: "Bahamas", length: 7, category: "NorthAmerica", mode: "Normal" },
    { name: "Bahrain", length: 7, category: "Asia", mode: "Normal" },
    { name: "Bangladesh", length: 10, category: "Asia", mode: "Normal" },
    { name: "Barbados", length: 8, category: "NorthAmerica", mode: "Normal" },
    { name: "Belarus", length: 7, category: "Europe", mode: "Normal" },
    { name: "Belgium", length: 7, category: "Europe", mode: "Normal" },
    { name: "Belize", length: 6, category: "NorthAmerica", mode: "Normal" },
    { name: "Benin", length: 5, category: "Africa", mode: "Normal" },
    { name: "Bhutan", length: 6, category: "Asia", mode: "Normal" },
    { name: "Bolivia", length: 7, category: "SouthAmerica", mode: "Normal" },
    { name: "Bosnia", length: 6, category: "Europe", mode: "Normal" },
    { name: "Botswana", length: 8, category: "Africa", mode: "Normal" },
    { name: "Brazil", length: 6, category: "SouthAmerica", mode: "Normal" },
    { name: "Brunei", length: 6, category: "Asia", mode: "Normal" },
    { name: "Bulgaria", length: 8, category: "Europe", mode: "Normal" },
    { name: "Burkina", length: 6, category: "Africa", mode: "Normal" },
    { name: "Burundi", length: 7, category: "Africa", mode: "Normal" },
    { name: "Cambodia", length: 8, category: "Asia", mode: "Normal" },
    { name: "Cameroon", length: 8, category: "Africa", mode: "Normal" },
  ];
